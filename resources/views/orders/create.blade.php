...
@section('content')
    <h1 class="text-3xl font-bold mb-6">Tambah Order</h1>
    ...
    <form action="{{ route('orders.store') }}" method="POST">
        ...
        <div id="order-items">
            <div class="mb-4 border p-4 rounded" data-index="0">
                <label class="block font-semibold mb-1">Produk</label>
                <select name="items[0][product_id]" class="w-full border border-gray-300 rounded px-3 py-2" required>
                ...
                <input type="number" name="items[0][quantity]" min="1" value="1" class="w-full border border-gray-300 rounded px-3 py-2" required>
        ...
        <button type="submit" class="bg-blue-600 hover:bg-blue-700 text-white font-semibold px-4 py-2 rounded">Buat Order</button>
    </form>
